...
class _HomeWorkPageState extends State<HomeWorkPage> {
  ...
  void initState() {
    ...
    subHome = widget.homeworkBloc.stream.listen((state) {
                    ...
                    return Expanded(
                      child: Column(
                        children: [
                          MyInputWidget(
                            focusNode: fName,
                            hintText: 'Enter the name of the homework',
                            label: 'Name',
                          ...
                          ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Container(
                                decoration: BoxDecoration(
                                    color: makeBackGroundColorListTile(homework
